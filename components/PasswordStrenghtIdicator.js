...
var PasswordStrengthMeter = (function (_Component) {
	...
	_createClass(PasswordStrengthMeter, [{
		...
		value: function handleInput(event) {
			...
			//var section = _reactDom2['default'].findDOMNode(this.refs.section);
			...
			var section = ReactDOM.findDOMNode(this.refs.section);
			...
			section.className = 'strength-' + result.score;
			...
			return(
				<section ref="section">
					<div className="password-meter-wrapper">
						...
						<input type="password" oninput={(e) => this.handleInput(e)} placeholder="Password" id="password" ref="password" />
					</div>
					<div id="password-strength-meter" ref="passwordStrengthMeter"></div>
					<p id="password-strength-text" ref="passwordStrengthText">{resultScore}</p>
				</section>
...
return _react2['default'].createElement(
	...
	_react2['default'].createElement(
		...
		_react2['default'].createElement(
			'label',
			{forHtml: 'password', className: 'hide'},
			passwordHeader
		),
		_react2['default'].createElement(
			'input',
			{ onInput: this.handleInput, placeholder: 'Password', type: 'password', name: 'password', id: 'password', ref: 'password' }
		),
		//_react2['default'].createElement('meter', { max: '4', id: 'password-strength-meter', ref: 'passwordStrengthMeter' }),
		_react2['default'].createElement(
			'div',
			{ id: 'password-strength-meter', ref: 'passwordStrengthMeter' }
		)
	),
